...
<script setup>
    ...
    let identifier = ""; //username or email
    let password = "";
    ...
    async function login(e) {
        ...
        try{
            const { data, pending, error, refresh } = await useFetch(`http://localhost:1337/api/auth/local`, {
                method: "POST",
                body: {
            ...
            await useAsyncData('user', () => userStore.setUser(jwt, user))
